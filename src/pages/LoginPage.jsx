...
export default function LoginPage () {
  return (
      <div className="w-screen flex text-secondary overflow-hidden">
        <div className="w-full h-auto flex flex-col justify-evenly my-8 mx-4 bg-secondary-gradient rounded-md">
            <Link to="/signup" className="flex justify-end pt-4 pr-2 text-xl ">Don&apos;t have an account? Sign up!</Link>
            <div className="flex flex-col items-center space-y-2">
                ...
                <form className="w-full flex flex-col items-center space-y-1">
                    ...
                    <input className="w-3/4 h-12 text-primary bg-modal-gradient border border-primary rounded-lg" type="submit" value="Log In"/>
                </form>
                <div className="w-full flex justify-around px-2 py-2 text-xl">
            ...
            <div className="w-full flex flex-col items-center space-y-1 pb-4">
