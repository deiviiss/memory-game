...
<button className="absolute top-2 right-2 w-30 h-30 border-none bg-transparent cursor-pointer transition-all duration-300 rounded-5 text-blue-500" onClick={() => setOpen(false)}>
